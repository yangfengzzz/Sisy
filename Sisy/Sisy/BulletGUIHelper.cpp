...
struct BulletGuiHelperInternalData
{
    Demo::GraphicsSystem* m_glApp;
...
//------------------------------------------------------------------------------------
int BulletGuiHelper::idx = 0;
BulletGuiHelper::BulletGuiHelper(Demo::GraphicsSystem *graphicsSystem )
{
    m_data = new BulletGuiHelperInternalData;
    m_data->m_glApp = graphicsSystem;
    m_data->m_debugDraw = 0;
}

BulletGuiHelper::~BulletGuiHelper()
{
...
void BulletGuiHelper::autogenerateGraphicsObjects(btDiscreteDynamicsWorld* rbWorld)
{
...
////-------------------------------------------------------------------------
//void BulletGuiHelper::setVRMode(bool vrMode)
//{
...
//void BulletGuiHelper::createRigidBodyGraphicsObject(btRigidBody* body, const btVector3& color)
//{
...
//void BulletGuiHelper::createCollisionObjectGraphicsObject(btCollisionObject* body, const btVector3& color)
//{
...
//}
//
//int BulletGuiHelper::registerTexture(const unsigned char* texels, int width, int height)
//{
//	int textureId = m_data->m_glApp->m_renderer->registerTexture(texels, width, height);
//	return textureId;
//}
//
//void BulletGuiHelper::removeTexture(int textureUid)
//{
//	m_data->m_glApp->m_renderer->removeTexture(textureUid);
//}
//
//void BulletGuiHelper::changeTexture(int textureUniqueId, const unsigned char* rgbTexels, int width, int height)
//{
...
//int BulletGuiHelper::registerGraphicsInstance(int shapeIndex, const float* position, const float* quaternion, const float* color, const float* scaling)
//{
//	return m_data->m_glApp->m_renderer->registerGraphicsInstance(shapeIndex, position, quaternion, color, scaling);
//}
//
//void BulletGuiHelper::removeAllGraphicsInstances()
//{
//	m_data->m_hashShapes.clear();
//	m_data->m_glApp->m_renderer->removeAllInstances();
//}
//
//void BulletGuiHelper::removeGraphicsInstance(int graphicsUid)
//{
//	if (graphicsUid >= 0)
//	{
...
//}
//
//int BulletGuiHelper::getShapeIndexFromInstance(int instanceUid)
//{
//	return m_data->m_glApp->m_renderer->getShapeIndexFromInstance(instanceUid);
//}
//
//void BulletGuiHelper::replaceTexture(int shapeIndex, int textureUid)
//{
//	if (shapeIndex >= 0)
//	{
...
//	};
//}
//void BulletGuiHelper::changeInstanceFlags(int instanceUid, int flags)
//{
//	if (instanceUid >= 0)
//	{
...
//	}
//}
//void BulletGuiHelper::changeRGBAColor(int instanceUid, const double rgbaColor[4])
//{
//	if (instanceUid >= 0)
//	{
...
//	};
//}
//void BulletGuiHelper::changeSpecularColor(int instanceUid, const double specularColor[3])
//{
//	if (instanceUid >= 0)
//	{
...
//	};
//}
//int BulletGuiHelper::createCheckeredTexture(int red, int green, int blue)
//{
//	int texWidth = 1024;
//	int texHeight = 1024;
