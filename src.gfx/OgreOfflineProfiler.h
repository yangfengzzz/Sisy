...
class _OgreExport OfflineProfiler
{
    ...
    public:
        ...
        void dumpProfileResultsStr( String &outCsvStringPerFrame,
                                   String &outCsvStringAccum );
        void dumpProfileResults( const String &fullPathPerFrame,
...
public:
     ...
     */
    void setDumpPathsOnShutdown( const String &fullPathPerFrame,
                                const String &fullPathAccum );
};
}
